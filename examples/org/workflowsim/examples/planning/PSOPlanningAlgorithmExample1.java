...
/**
 * This PSOPlanningAlgorithmExample1 creates a workflow planner, a workflow
 * engine, and one schedulers, one data centers and 80 homogeneous vms.
 *
 * @author Ramya Sarma, Anusha Holla
...
public class PSOPlanningAlgorithmExample1 extends WorkflowSimBasicExample1{
    ...
    protected static List<CondorVM> createVM(int userId, int vms) {
        ...
        for (int i = 0; i < vms; i++) {
            ...
            //To create heterogeneous VMs, multiply mips by ratio
            vm[i] = new CondorVM(
                     i,
                    userId,
                    mips,
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            String daxPath = "C:/Users/Ramya/Desktop/dax/Montage_2000.xml";
            ...
            /**
             * Since we are using PSO planning algorithm, the scheduling algorithm should be static 
